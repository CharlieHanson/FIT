...
import { buildPersonalizedQuery, UserPreferences } from './personalizedSearch';
...
export async function fetchComplementProducts(
  item: ClothingItem,
  ...
  const query = buildPersonalizedQuery(searchCategory, prefs, `${matchColor} ${style}`);
